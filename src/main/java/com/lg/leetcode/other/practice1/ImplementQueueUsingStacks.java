...
/**
 * @author Xulg
 * Description: leetcode_232
 * Created in 2021-05-31 16:57
 */
class ImplementQueueUsingStacks {
     ...
     *
     *  Follow-up:
     *       Can you implement the queue such that each operation is amortized O(1) time complexity? In other
     *      words, performing n operations will take overall O(n) time even if one of those operations may take
     *      longer.
     *
     * Example 1:
     * Input
